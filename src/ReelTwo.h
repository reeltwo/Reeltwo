...
#ifdef DEBUG_SERIAL
#if defined(ARDUINO_USB_CDC_ON_BOOT) && defined(NEED_DEBUG_SERIAL_TIMEOUT)
 #define DEBUG_SERIAL_READY() { DEBUG_SERIAL.begin(DEFAULT_BAUD_RATE); DEBUG_SERIAL.setTxTimeoutMs(0); }
#else
